...
const SYSTEM_PROMPT = `You are the conversational AI interface for a full-stack app generation platform. You help users design, build, and ship web applications.
